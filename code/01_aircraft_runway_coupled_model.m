close all; clc; clear;
timing = struct();
Run_ans = load(fullfile('data','confidential','Run_result_input.mat'));
result_filename = 'Air_Run_result_120_50_30_sub7_C0w0_Enwell_2.mat';
...
fprintf('预计算不平整度数据...\n');
shice = load(fullfile('data','example_roughness_profile.mat'));
