...
Energy_data = xlsread(fullfile('data','calibration','Energy_Dissipation_Results.xlsx'), 'Eca_total', 'B2:K21');
...
param_range = xlsread(fullfile('data','calibration','Parameter_Ranges.xlsx'), 'Sheet1', 'B2:Q3');
...
[~, ~, raw_weight] = xlsread(fullfile('data','calibration','Aircraft_Weights.xlsx'));
...
for iter = 1:max_iter
    ...
    for p = 1:n_particles
        ...
        for runway_idx = 1:n_runways
            ...
            mat_filename = fullfile('data','roughness_profiles',sprintf('roughnessresult_%d.mat', rwy_num));
